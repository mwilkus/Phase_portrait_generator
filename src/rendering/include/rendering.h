...
void render_curve(SDL_Renderer *renderer,std::vector<std::pair<double, double>> *curve, double scale);
...
void render_scale(SDL_Renderer *renderer, SDL_Texture *line, double scale,TTF_Font *font);
